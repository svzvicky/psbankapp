		...
		<div class="row">
			<div class="col-12">
				<div class="jumbotron">
					...
					<p class="lead ">A good Bank for better future</p>
		...
		<div class="row">
			<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
				<div class="card" style="Height: 200px">
					...
					<img src="/PSBankApp/resources/images/stay-online.png"
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="card" style="Height: 200px">
					...
					<img src="/PSBankApp/resources/images/stay-phone.png"
						class="card-img-top" alt="Phone"  />
					<div class="card-body">
						<p class="card-text">75+ Transactions on your Phone</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="card" style="Height: 200px">
					...
					<img src="/PSBankApp/resources/images/stay-social.jpg"
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="card" style="Height: 200px">
					...
					<img src="/PSBankApp/resources/images/India.jpg" class="card-img-top" alt="Watch" style="Width:60%;Height:55px"/>
					<div class="card-body">
