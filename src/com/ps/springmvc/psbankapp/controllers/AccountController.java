...
public class AccountController {
	...
	public String saveAccount(@Valid @ModelAttribute("account") Account account, BindingResult result, Model model) {
		...
		/*
		 * if (result.hasErrors()) { return "account-form"; } else {
		 * accountService.saveAccount(account); return "redirect:/list"; }
		 */
		if (result.hasErrors()) {
			return "account-form";
		} else {
	...
	public String deleteAccountconfirmation(@RequestParam("accountNo") int accountNo, Model model) {
		Account account = accountService.getAccount(accountNo);
		model.addAttribute("account", account);
		return "account-form";
